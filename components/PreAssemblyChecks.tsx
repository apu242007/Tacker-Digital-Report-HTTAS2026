        ...
        return (
          <div key={check.id} className="border-b border-gray-200 pb-2 mb-2">
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2">
              <div className="w-full sm:w-2/3 pr-2">
              ...
              <div className="w-full sm:w-1/3 flex items-center justify-start sm:justify-end mt-1 sm:mt-0 gap-2">
                {check.isYesNo ? (
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="relative">
                      <input 
                        ...
                        placeholder="0.00"
                        title={`Medida registrada: ${check.description}`}
                      />
